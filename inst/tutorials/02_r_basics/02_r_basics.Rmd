...
We will use self-guided tutorials throughout the workshop.
Just read the instructions and test your skills by writing and running code in the dedicated boxes.
If you see three dots `...` in the code box, you have to delete them and write code instead based on the prompt.
